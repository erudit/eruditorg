...
class DummyModel(models.Model):
    ...
    resized_image = SizeConstrainedImageField(
        upload_to='eruditcore/test_images', width=RESIZED_IMAGE_WIDTH, height=RESIZED_IMAGE_HEIGHT,
        null=True, blank=True)
    validated_image = SizeConstrainedImageField(
        upload_to='eruditcore/test_images', min_width=VALIDATED_IMAGE_MIN_WIDTH,

...
class TestLegacyJournalUrlPatterns:
    @pytest.mark.parametrize(
        "journal_code, year, volume, number, expected_url",
        [
    ...
    @pytest.mark.parametrize(
        "journal_code, year, volume, local_id, expected_url",
        [
    ...
    def test_legacy_issue_detail_culture_year_volume(
        self, journal_code, year, volume, local_id, expected_url
    ):
        url = reverse(
            "legacy_journal:legacy_issue_detail_culture_year_volume",
            args=[
                journal_code,
                year,
                volume,
    ...
    def test_legacy_issue_detail_culture_year_volume_index(
        self, journal_code, year, volume, local_id, expected_url
    ):
        url = reverse(
            "legacy_journal:legacy_issue_detail_culture_year_volume_index",
            args=[
                journal_code,
                year,
                volume,
    ...
    @pytest.mark.parametrize(
        "journal_code, local_id, expected_url",
        [
    ...
    @pytest.mark.parametrize(
        "journal_code, year, volume, number, local_id, format_id, expected_url",
        [
            ...
            (
                ...
                "bar-2",
                "pdf",
                "/revue/foo-1/2000/v1-2/n3-4/bar-2.pdf",
            ),
    ...
    def test_legacy_article_detail(
        self, journal_code, year, volume, number, local_id, format_id, expected_url
    ):
        url = reverse(
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                "bar-2",
                "pdf",
                "/culture/foo-1/2000/v1-2/n3-4/bar-2.pdf",
            ),
    ...
    def test_legacy_article_detail_culture(
        self, journal_code, year, volume, number, local_id, format_id, expected_url
    ):
        url = reverse(
    ...
    @pytest.mark.parametrize(
        "journal_code, issue_id, local_id, format_id, expected_url",
        [
            ("foo", "bar", "baz", "html", "/culture/foo/bar/baz.html"),
            ("foo-1", "bar-2", "baz-3", "pdf", "/culture/foo-1/bar-2/baz-3.pdf"),
        ],
    )
    def test_legacy_article_detail_culture_localidentifier(
        self, journal_code, issue_id, local_id, format_id, expected_url
    ):
        url = reverse(

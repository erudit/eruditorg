...
class TestGetStatsForm:
    def test_can_bind_form_if_submitted(self):
        form_info = StatsFormInfo(form_class=CounterJR1Form, code='formcode', tab_label='',
                                  title='', description='', counter_release='R4')
...
@pytest.mark.parametrize('current_year,last_sub_year,expected',

...
class SearchForm(forms.Form):
    ...
    # years_filter = forms.MultipleChoiceField(label=_("Années de publication"), choices={}, widget=forms.CheckboxSelectMultiple, required=False, )
    # languages_filter = forms.MultipleChoiceField(label=_("Langues"), choices={}, widget=forms.CheckboxSelectMultiple, required=False, )
    # authors_filter = forms.MultipleChoiceField(label=_("Auteurs"), choices={}, widget=forms.CheckboxSelectMultiple, required=False, )
    # funds_filter = forms.MultipleChoiceField(label=_("Fonds"), choices={}, widget=forms.CheckboxSelectMultiple, required=False, )
    # publication_types_filter = forms.MultipleChoiceField(label=_("Types de publication"), choices={}, widget=forms.CheckboxSelectMultiple, required=False, )

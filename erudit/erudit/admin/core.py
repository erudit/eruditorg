...
from core.permissions.admin import ObjectPermissionInline
...
class JournalObjectPermissionInline(ObjectPermissionInline):
    permission_filters = (
...
class JournalAdmin(admin.ModelAdmin):
    inlines = (JournalObjectPermissionInline, )

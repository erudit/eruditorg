    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=models.deletion.CASCADE, to='contenttypes.ContentType', blank=True, verbose_name='Type', null=True)),
                ('group', models.ForeignKey(on_delete=models.deletion.CASCADE, to='auth.Group', blank=True, null=True)),
                ('user', models.ForeignKey(on_delete=models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, blank=True, null=True)),
            ],
            options={

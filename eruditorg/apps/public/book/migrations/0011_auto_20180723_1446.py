...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='bookcollection',
            options={'verbose_name': 'Collection d’actes ou de livres', 'verbose_name_plural': 'Collections d’actes ou de livres'},
        ),
        ...
        migrations.AlterField(
            model_name='book',
            name='digital_isbn',
            field=models.CharField(blank=True, max_length=20, null=True, verbose_name='ISBN numérique'),
        ),
        migrations.AlterField(
            model_name='book',
            name='isbn',

...
urlpatterns = [
    ...
    url(_(r'^individuel/abonner-en-lot/'),
        views.JournalIndividualSubscriptionBatchSubscribe.as_view(), name='batch_subscribe'),
    url(_(r'^individuel/supprimer-en-lot/'),
        views.JournalIndividualSubscriptionBatchDelete.as_view(), name='batch_delete'),

...
class IndividualJournalAccessSubscriptionListView(JournalSubscriptionMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super(IndividualJournalAccessSubscriptionListView, self).get_context_data(
            **kwargs
        )
        context["pending_subscriptions"] = AccountActionToken.pending_objects.get_for_object(
...
class IndividualJournalAccessSubscriptionCreateView(JournalSubscriptionMixin, CreateView):
    ...
    def get(self, request, *args, **kwargs):
        try:
            ...
            return super(IndividualJournalAccessSubscriptionCreateView, self).get(
                request, *args, **kwargs
            )
...
class JournalIndividualSubscriptionBatchSubscribe(JournalSubscriptionMixin, TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if toadd:
            ...
            url = reverse("userspace:journal:subscription:list", args=(self.current_journal.pk,))

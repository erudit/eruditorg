...
from ...generic_apps.authorization.views import (
    AuthorizationUserView as BaseAuthorizationUserView,
)
...
class AuthorizationUserView(
    ...
    def get_authorizations_per_app(self):
        ...
        if AC.can_manage_individual_subscription.codename in data:
            if not JournalManagementSubscription.objects.filter(
...
class AuthorizationCreateView(
    ...
    def has_permission(self):
        ...
        if (
            has_perm
            and auth_codename == AC.can_manage_individual_subscription.codename

...
class OrganisationMembershipTokenCreateForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        token_already_exists = AccountActionToken.pending_objects \
            .get_for_object(self.organisation) \
            .filter(action=OrganisationMembershipAction.name, email=email).exists()

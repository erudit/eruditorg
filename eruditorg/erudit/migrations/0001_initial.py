    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "firstname",
                    models.CharField(null=True, max_length=50, blank=True, verbose_name="Prénom"),
                ),
                (
                    "email",
                    models.EmailField(
                        null=True, max_length=254, blank=True, verbose_name="Courriel"
                    ),
                ),
                (
                    "suffix",
                    models.CharField(null=True, max_length=20, blank=True, verbose_name="Suffixe"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "synced_with_edinum",
                    models.BooleanField(default=False, verbose_name="Synchronisé avec Edinum"),
                ),
                (
                    "edinum_id",
                    models.CharField(
                        null=True, max_length=7, blank=True, verbose_name="Identifiant Edinum"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_start",
                    models.DateField(
                        help_text="Date de début du contrat, format aaaa-mm-jj",
                        verbose_name="Début",
                    ),
                ),
                (
                    "date_end",
                    models.DateField(
                        help_text="Date de fin du contrat, format aaaa-mm-jj", verbose_name="Fin"
                    ),
                ),
                (
                    "date_signature",
                    models.DateField(
                        null=True,
                        help_text="Date de signature du contrat, format aaaa-mm-jj",
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Court identifiant utilisé dans le nom automatique des contrats",
                        max_length=255,
                        verbose_name="Code",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "localidentifier",
                    models.CharField(max_length=50, unique=True, verbose_name="Identifiant Fedora"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        choices=[
                            (1, "Création de soumission"),
                            (2, "Changement de statut de soumission"),
                        ]
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_start",
                    models.DateField(null=True, blank=True, verbose_name="Date de début"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(help_text="Acronyme", max_length=255, verbose_name="Code"),
                ),
                ("name", models.CharField(max_length=255, verbose_name="Nom")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        null=True,
                        help_text="Identifiant de la facture dans SAGE.",
                        blank=True,
                        verbose_name="Id facture SAGE",
                    ),
                ),
                (
                    "id_subcontractor",
                    models.IntegerField(
                        null=True,
                        help_text="Identifiant de la facture du sous-contractant qui couvre cette facture (ex.: CEN-R).",
                        blank=True,
                        verbose_name="Id facture sous-contractant",
                    ),
                ),
                ...
                (
                    ...
                    models.DecimalField(
                        max_digits=15,
                        help_text="Total de la facture du sous-contractant (ex.: CEN-R)",
                        decimal_places=2,
                        blank=True,
                        null=True,
                        verbose_name="Total facture sous-contractant",
                    ),
                ),
                (
                    "total",
                    models.DecimalField(
                        null=True, max_digits=15, decimal_places=2, blank=True, verbose_name="Total"
                    ),
                ),
                (
                    "status",
                    models.CharField(
                        choices=[("D", "Draft"), ("V", "Valid"), ("S", "Sent"), ("P", "Paid")],
                        max_length=255,
                        verbose_name="Statut",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "volume",
                    models.CharField(null=True, max_length=255, blank=True, verbose_name="Volume"),
                ),
                (
                    "number",
                    models.CharField(null=True, max_length=255, blank=True, verbose_name="Numéro"),
                ),
                (
                    "special_issue",
                    models.BooleanField(
                        help_text="Cocher s'il s'agit d'un numéro spécial.",
                        default=False,
                ...
                (
                    "date_produced",
                    models.DateField(null=True, blank=True, verbose_name="Date de production"),
                ),
                (
                    "date_published",
                    models.DateField(null=True, blank=True, verbose_name="Date de publication"),
                ),
                (
                    "open_access",
                    models.NullBooleanField(
                        help_text="Cocher si ce numéro est en accès libre",
                        default=None,
                        verbose_name="Accès libre",
                    ),
                ),
                (
                    "localidentifier",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Nom officiel", max_length=255, verbose_name="Nom"),
                ),
                (
                    "display_name",
                    models.CharField(
                ...
                (
                    "issn_print",
                    models.CharField(
                        null=True, max_length=255, blank=True, verbose_name="ISSN imprimé"
                    ),
                ),
                (
                    "issn_web",
                    models.CharField(
                        null=True, max_length=255, blank=True, verbose_name="ISSN web"
                    ),
                ),
                ...
                (
                    "issues_per_year",
                    models.IntegerField(null=True, blank=True, verbose_name="Numéros par année"),
                ),
                ...
                (
                    "upcoming",
                    models.BooleanField(default=False, verbose_name="Prochainement disponible"),
                ),
                (
                    "collection",
                    models.ForeignKey(
                ...
                (
                    "disciplines",
                    models.ManyToManyField(related_name="journals", to="erudit.Discipline"),
                ),
                (
                    "formerly",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="journals", to=settings.AUTH_USER_MODEL, verbose_name="Membres"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "editorial_policy",
                    models.TextField(null=True, blank=True, verbose_name="Politique éditoriale"),
                ),
                (
                    "editorial_policy_fr",
                    models.TextField(null=True, blank=True, verbose_name="Politique éditoriale"),
                ...
                (
                    "subscriptions",
                    models.TextField(null=True, blank=True, verbose_name="Abonnements"),
                ),
                (
                    "subscriptions_fr",
                    models.TextField(null=True, blank=True, verbose_name="Abonnements"),
                ...
                (
                    "partners_fr",
                    models.TextField(null=True, blank=True, verbose_name="Partenaires"),
                ),
                (
                    "partners_en",
                    models.TextField(null=True, blank=True, verbose_name="Partenaires"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(null=True, max_length=255, blank=True, verbose_name="Nom"),
                ),
                (
                    "code",
                    models.SlugField(
                        choices=[("C", "Culturel"), ("S", "Savant")],
                        max_length=2,
                        unique=True,
                        verbose_name="Code",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "street",
                    models.CharField(null=True, max_length=200, blank=True, verbose_name="Adresse"),
                ),
                (
                    "postal_code",
                    models.CharField(
                        null=True, max_length=50, blank=True, verbose_name="Code postal"
                    ),
                ),
                (
                    "city",
                    models.CharField(null=True, max_length=50, blank=True, verbose_name="Ville"),
                ),
                (
                    "province",
                    models.CharField(null=True, max_length=50, blank=True, verbose_name="Province"),
                ),
                (
                    "country",
                    models.CharField(null=True, max_length=50, blank=True, verbose_name="Pays"),
                ),
                (
                    "badge",
                    models.ImageField(
                        null=True, upload_to="organisation_badges", blank=True, verbose_name="Badge"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total",
                    models.DecimalField(null=True, decimal_places=2, blank=True, max_digits=15),
                ),
                (
                    "currency",
                    models.ForeignKey(
                ...
                (
                    "quotation",
                    models.ForeignKey(on_delete=models.deletion.CASCADE, to="erudit.Quotation"),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price",
                    models.DecimalField(
                        null=True, max_digits=15, decimal_places=2, blank=True, verbose_name="Prix"
                    ),
                ),
                ("approved", models.BooleanField(default=False, verbose_name="Approuvé")),
                (
                    "date_approved",
                    models.DateField(null=True, blank=True, verbose_name="Date d'approbation"),
                ),
                (
                    "currency",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "processing",
                    models.CharField(choices=[("C", "Complet"), ("M", "Minimal")], max_length=1),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, to="erudit.SubscriptionType", verbose_name="Type"
            ),
        ),
        migrations.AddField(
            model_name="subscriptionprice",
            name="zone",
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, to="erudit.SubscriptionZone", verbose_name="Zone"
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE,
                help_text="Centre de production responsable\n            de la production de la revue.",
                blank=True,
                null=True,
                verbose_name="Centre de production",
                to="erudit.ProductionCenter",
            ),
        ),
        migrations.AddField(
            model_name="journalproduction",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="journals", to="erudit.Publisher", verbose_name="Éditeur"
            ),
        ),
        migrations.AddField(
            model_name="journal",
        ...
        migrations.AddField(
            ...
            name="indexer",
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE, to="erudit.Indexer", verbose_name="Indexeur"
            ),
        ),
        migrations.AddField(
            model_name="indexation",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=models.deletion.CASCADE,
                help_text="Revue ayant obtenu cette subvention",
                to="erudit.Journal",
                related_name="grants",
                verbose_name="Revue",
            ),
        ...
        migrations.AddField(
            ...
            name="journals",
            field=models.ManyToManyField(
                help_text="Choisir les revues composant ce panier.",
                to="erudit.Journal",
                verbose_name="Revues",
            ),
        ),

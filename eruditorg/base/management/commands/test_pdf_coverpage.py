    ...
    def handle(self, *args, **options):
        ...
        with open('./pdf_coverpages.pdf', 'wb') as pdf:
            ...
            if additional_ids is not None and custom_ids is not None:
                raise CommandError('Cannnot use both --additional-id-list and --custom-id-list arguments.')  # noqa
            ...
            for fedora_id in fedora_ids:
                try:
                    ...
                    raise CommandError('Invalid ID "{}", should be in the form "erudit:<collection_id>.<journal_id>.<issue_id>.<article_id>".'.format(fedora_id))  # noqa

...
LOGGING = {
    ...
    "formatters": {
        ...
        "structlog": {"format": "%(levelname)s %(message)s"},
    ...
    "handlers": {
        "console": {"level": "INFO", "class": "logging.StreamHandler", "formatter": "structlog"},
        "cron_console": {
            "level": "ERROR",
...
ANALYTICS_TRACKING_CODES = [
    tc for tc in [ANALYTICS_HOTJAR_TRACKING_CODE, ANALYTICS_GOOGLE_TRACKING_CODE] if tc
]

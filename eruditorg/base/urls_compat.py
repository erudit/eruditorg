...
thesis_url_patterns = (
    [
        url(r"^$", RedirectRetroUrls.as_view(pattern_name="public:thesis:home")),
        url(r"^liste.html?$", RedirectRetroUrls.as_view(pattern_name="public:thesis:home")),
        url(r"^index\.html?$", RedirectRetroUrls.as_view(pattern_name="public:thesis:home")),
    ],
    "legacy_thesis",
)
...
public_url_patterns = [
    url(r"^client/login.jsp$", RedirectRetroUrls.as_view(pattern_name="public:auth:login")),
    url(
...
book_url_patterns = (
    [
        url(r"^$", book_views_compat.BooksHomeRedirectView.as_view(), name="legacy_books_home"),
        url(
